export const accordionData = {
  ...
  "What is coming for this platform in the near future?": [
    {
      text: "Charity:",
      sxProps: { fontWeight: 500, color: "white.light" },
    },
    {
      text: "In the future this platform will be able to service most needs of a well-running charity. It will include Grant-writing, Operations management, one-click social media campaigns, and much more.",
      sxProps: {},
    },
    {
      text: "Donor:",
    ...
    {
      text: "As a donor you will be able to vote on a monthly pool of $, to go to whichever charity/project you would like. Furthermore, there will be personalised reports for donations & the impact you have achieved (Proof of Impact).",
      sxProps: {},
    },
  ],
  // ... other entries follow the same structure
};
